                ...
                <div class="card m-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="card-body">
                            ...
                            <form action="Admin.php?PageName=ManageSkill" method="post" class="">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 form-group">
                                        <input type="text" name="title" id="title" placeholder="skill title" class="form-control" required>
                                    </div>

                                    <div class="col-lg-1"></div>
                                    <div class="col-lg-3">
                                        <label for="">Skill Strength</label>
                                    </div>
                                    <div class="col-lg-8 form-group">
                                        <input type="number" name="strength" class="form-control" placeholder="enter percentage between 0 to 100" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 form-group text-center">
                                        <input class="form-control btn btn-dark" type="submit" name="submitSkillForm" value="Submit" required>
                                    </div>
                                    <div class="col-lg-3 col-md-6 form-group text-center">
                                            ...
                                            <!-- Edit Modal Structure -->
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="Admin.php?PageName=AddNewSkill" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="strength">Skill Strength</label>
                                                            <input type="number" class="form-control" name="strength" value="<?php echo $row['strength']; ?>" required>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="submit" name='submitEditSkillForm' class="btn btn-primary">Save changes</button>
