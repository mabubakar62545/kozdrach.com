                ...
                <div class="card m-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="card-body">
                            ...
                            <form action="Admin.php?PageName=ManageProjects" method="post" class="">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 form-group text-center">
                                        <input class="form-control btn btn-dark" type="submit" name="submitProjectForm" value="Submit" required>
                                    </div>
                                    <div class="col-lg-3 col-md-6 form-group text-center">
                                            ...
                                            <!-- Edit Modal Structure -->
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="Admin.php?PageName=ManageProjects" method="post">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" name='submitEditProjectForm' class="btn btn-primary">Save changes</button>
...
<script>
    ...
    if (confirm("Are you sure you want to delete this record?")) {
        window.location.href = 'Admin.php?PageName=ManageProjects&projectId=' + id;
    }
}
</script>